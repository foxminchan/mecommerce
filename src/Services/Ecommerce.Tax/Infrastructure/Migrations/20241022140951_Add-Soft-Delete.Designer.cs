...
namespace Ecommerce.Tax.Infrastructure.Migrations
{
    ...
    [Migration("20241022140951_Add-Soft-Delete")]
            ...
            modelBuilder.Entity("Ecommerce.Tax.Domain.CalculationAggregate.Calculation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 22, 14, 9, 50, 776, DateTimeKind.Utc).AddTicks(7615))
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 22, 14, 9, 50, 777, DateTimeKind.Utc).AddTicks(8345))
            ...
            modelBuilder.Entity("Ecommerce.Tax.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 22, 14, 9, 50, 782, DateTimeKind.Utc).AddTicks(7332))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 10, 22, 14, 9, 50, 782, DateTimeKind.Utc).AddTicks(7808))
                        .HasColumnName("last_modified_at");
