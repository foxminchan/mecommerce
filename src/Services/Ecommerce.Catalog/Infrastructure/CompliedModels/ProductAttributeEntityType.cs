...
namespace Ecommerce.Catalog.Infrastructure.CompliedModels
{
    internal partial class ProductAttributeEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 9, 25, 5, 15, 5, 324, DateTimeKind.Utc).AddTicks(8348));
            ...
            lastModifiedAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 9, 25, 5, 15, 5, 324, DateTimeKind.Utc).AddTicks(8811));
