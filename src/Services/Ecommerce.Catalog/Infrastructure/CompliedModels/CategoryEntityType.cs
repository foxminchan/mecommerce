...
namespace Ecommerce.Catalog.Infrastructure.CompliedModels
{
    internal partial class CategoryEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 9, 25, 5, 15, 5, 323, DateTimeKind.Utc).AddTicks(2419));
        ...
        lastModifiedAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 9, 25, 5, 15, 5, 323, DateTimeKind.Utc).AddTicks(2867));
