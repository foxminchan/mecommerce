...
namespace Ecommerce.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20240925051514_Initiallize-Database")]
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.BrandAggregate.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 403, DateTimeKind.Utc).AddTicks(6049))
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 403, DateTimeKind.Utc).AddTicks(6426))
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 404, DateTimeKind.Utc).AddTicks(1623))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 404, DateTimeKind.Utc).AddTicks(1991))
                        .HasColumnName("last_modified_at");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.ProductAggregate.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 406, DateTimeKind.Utc).AddTicks(5053))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 406, DateTimeKind.Utc).AddTicks(5412))
                        .HasColumnName("last_modified_at");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.ProductAttributeAggregate.ProductAttribute", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 405, DateTimeKind.Utc).AddTicks(6896))
                        .HasColumnName("created_at");

                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 405, DateTimeKind.Utc).AddTicks(7249))
                        .HasColumnName("last_modified_at");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.ProductAttributeGroupAggregate.ProductAttributeGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 405, DateTimeKind.Utc).AddTicks(9886))
                        .HasColumnName("created_at");

                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 406, DateTimeKind.Utc).AddTicks(146))
                        .HasColumnName("last_modified_at");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.VariantAggregate.Variant", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 411, DateTimeKind.Utc).AddTicks(5134))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime?>("LastModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 25, 5, 15, 14, 411, DateTimeKind.Utc).AddTicks(5437))
                        .HasColumnName("last_modified_at");
