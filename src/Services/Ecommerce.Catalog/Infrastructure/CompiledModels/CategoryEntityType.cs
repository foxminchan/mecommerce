...
namespace Ecommerce.Catalog.Infrastructure.CompiledModels
{
    internal partial class CategoryEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 11, 13, 59, 11, 881, DateTimeKind.Utc).AddTicks(4407));
        ...
        var displayOrder = runtimeEntityType.AddProperty(
            "DisplayOrder",
            typeof(int),
            propertyInfo: typeof(Category).GetProperty("DisplayOrder", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Category).GetField("<DisplayOrder>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            sentinel: 0);
        ...
        var isPublished = runtimeEntityType.AddProperty(
            "IsPublished",
            typeof(bool),
            propertyInfo: typeof(Category).GetProperty("IsPublished", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Category).GetField("<IsPublished>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            sentinel: false);
        ...
        lastModifiedAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 11, 13, 59, 11, 881, DateTimeKind.Utc).AddTicks(4811));

        var metaDescription = runtimeEntityType.AddProperty(
            "MetaDescription",
            typeof(string),
            propertyInfo: typeof(Category).GetProperty("MetaDescription", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Category).GetField("<MetaDescription>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            nullable: true,
            maxLength: 255);
    ...
    var metaKeywords = runtimeEntityType.AddProperty(
        "MetaKeywords",
        typeof(string),
        propertyInfo: typeof(Category).GetProperty("MetaKeywords", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(Category).GetField("<MetaKeywords>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        nullable: true,
        maxLength: 255);
...
var metaTitle = runtimeEntityType.AddProperty(
    "MetaTitle",
    typeof(string),
    propertyInfo: typeof(Category).GetProperty("MetaTitle", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    fieldInfo: typeof(Category).GetField("<MetaTitle>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    nullable: true,
    maxLength: 255);
...
var thumbnailId = runtimeEntityType.AddProperty(
    "ThumbnailId",
    typeof(Guid?),
    propertyInfo: typeof(Category).GetProperty("ThumbnailId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    fieldInfo: typeof(Category).GetField("<ThumbnailId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
    nullable: true);
...
var index = runtimeEntityType.AddIndex(
    new[] { displayOrder },
    unique: true);
index.AddAnnotation("Relational:Name", "ix_categories_display_order");

var index0 = runtimeEntityType.AddIndex(
    new[] { parentId });
index0.AddAnnotation("Relational:Name", "ix_categories_parent_id");

var index1 = runtimeEntityType.AddIndex(
    new[] { slug },
    unique: true);
index1.AddAnnotation("Relational:Name", "ix_categories_slug");
...
public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
{
    ...
    var children = principalEntityType.AddNavigation("Children",
        runtimeForeignKey,
        onDependent: false,
        typeof(IReadOnlyCollection<Category>),
        propertyInfo: typeof(Category).GetProperty("Children", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        fieldInfo: typeof(Category).GetField("_children", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

    runtimeForeignKey.AddAnnotation("Relational:Name", "fk_categories_categories_parent_id");
