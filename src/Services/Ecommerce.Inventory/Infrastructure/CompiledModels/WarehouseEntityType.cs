...
{
    internal partial class WarehouseEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var capacity = runtimeEntityType.AddProperty(
                "Capacity",
                typeof(long),
                propertyInfo: typeof(Warehouse).GetProperty("Capacity", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Warehouse).GetField("<Capacity>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0L);
            capacity.TypeMapping = LongTypeMapping.Default.Clone(
                comparer: new ValueComparer<long>(
                    (long v1, long v2) => v1 == v2,
                    (long v) => v.GetHashCode(),
                    (long v) => v),
            ...
            capacity.AddAnnotation("Relational:ColumnName", "capacity");
            ...
            createdAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 18, 16, 19, 43, 923, DateTimeKind.Utc).AddTicks(5445));
            ...
            lastModifiedAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 18, 16, 19, 43, 923, DateTimeKind.Utc).AddTicks(5729));

            var name = runtimeEntityType.AddProperty(
                "Name",
                typeof(string),
                propertyInfo: typeof(Warehouse).GetProperty("Name", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Warehouse).GetField("<Name>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 255);
        ...
        key.AddAnnotation("Relational:Name", "pk_warehouses");
    ...
    public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
    {
        ...
        runtimeEntityType.AddAnnotation("Relational:TableName", "warehouses");
