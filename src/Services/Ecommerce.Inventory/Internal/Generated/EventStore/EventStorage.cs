...
namespace Marten.Generated.EventStore
{
    ...
    public class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        {
            builder.Append("insert into stock_history.mt_events (data, type, mt_dotnet_type, id, stream_id, version, timestamp, tenant_id, correlation_id, causation_id, headers, seq_id) values (");
            ...
            var parameter10 = parameterBuilder.AppendParameter(session.Serializer.ToJson(Event.Headers));
            parameter10.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Jsonb;
            var parameter11 = parameterBuilder.AppendParameter(Event.Sequence);
            parameter11.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Bigint;
            builder.Append(')');
        }
    ...
    public class AppendEventOperationQuickWithVersion : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            var parameter10 = parameterBuilder.AppendParameter(session.Serializer.ToJson(Event.Headers));
            parameter10.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Jsonb;
            builder.Append(",nextval('stock_history.mt_events_sequence')");
            builder.Append(')');
        }
    ...
    public class QuickAppendEventsOperation : Marten.Events.Operations.QuickAppendEventsOperationBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            builder.Append("select stock_history.mt_quick_append_events(");
            var parameterBuilder = builder.CreateGroupedParameterBuilder(',');
    ...
    public class GeneratedInsertStream : Marten.Events.Operations.InsertStreamBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            builder.Append("insert into stock_history.mt_streams (id, type, version, tenant_id) values (");
            var parameterBuilder = builder.CreateGroupedParameterBuilder(',');
    ...
    public class GeneratedStreamStateQueryHandler : Marten.Events.Querying.StreamStateQueryHandler
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            builder.Append("select id, version, type, timestamp, created as timestamp, is_archived from stock_history.mt_streams where id = ");
    ...
    public class GeneratedStreamVersionOperation : Marten.Events.Operations.UpdateStreamVersion
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            builder.Append("update stock_history.mt_streams ");
            var parameterBuilder = builder.CreateGroupedParameterBuilder();
