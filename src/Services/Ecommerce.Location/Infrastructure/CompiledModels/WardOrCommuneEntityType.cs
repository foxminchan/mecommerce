...
{
    internal partial class WardOrCommuneEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 13, 14, 50, 22, 931, DateTimeKind.Utc).AddTicks(9207));

            var districtId = runtimeEntityType.AddProperty(
                "DistrictId",
                typeof(long),
                propertyInfo: typeof(WardOrCommune).GetProperty("DistrictId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(WardOrCommune).GetField("<DistrictId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0L);
            districtId.TypeMapping = LongTypeMapping.Default.Clone(
                comparer: new ValueComparer<long>(
                    (long v1, long v2) => v1 == v2,
                    (long v) => v.GetHashCode(),
                    (long v) => v),
                ...
                providerValueComparer: new ValueComparer<long>(
                    ...
                    (long v) => v.GetHashCode(),
                    (long v) => v));
            districtId.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
            districtId.AddAnnotation("Relational:ColumnName", "district_id");
            ...
            lastModifiedAt.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 10, 13, 14, 50, 22, 931, DateTimeKind.Utc).AddTicks(9418));

            var name = runtimeEntityType.AddProperty(
                "Name",
                typeof(string),
                propertyInfo: typeof(WardOrCommune).GetProperty("Name", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(WardOrCommune).GetField("<Name>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 500);
        ...
        var type = runtimeEntityType.AddProperty(
            "Type",
            typeof(Type),
            propertyInfo: typeof(WardOrCommune).GetProperty("Type", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(WardOrCommune).GetField("<Type>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        key.AddAnnotation("Relational:Name", "pk_ward_or_communes");

        var index = runtimeEntityType.AddIndex(
            new[] { districtId });
        index.AddAnnotation("Relational:Name", "ix_ward_or_communes_district_id");
    ...
    {
        var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("DistrictId") },
            principalEntityType.FindKey(new[] { principalEntityType.FindProperty("Id") }),
            principalEntityType,
            deleteBehavior: DeleteBehavior.Cascade,
            required: true);

        var district = declaringEntityType.AddNavigation("District",
            runtimeForeignKey,
            onDependent: true,
            typeof(District),
            propertyInfo: typeof(WardOrCommune).GetProperty("District", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(WardOrCommune).GetField("<District>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

        var wardOrCommunes = principalEntityType.AddNavigation("WardOrCommunes",
            runtimeForeignKey,
            onDependent: false,
            typeof(IReadOnlyCollection<WardOrCommune>),
            propertyInfo: typeof(District).GetProperty("WardOrCommunes", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(District).GetField("_wardOrCommunes", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

        runtimeForeignKey.AddAnnotation("Relational:Name", "fk_ward_or_communes_districts_district_id");
    ...
    public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
    {
        ...
        runtimeEntityType.AddAnnotation("Relational:TableName", "ward_or_communes");
