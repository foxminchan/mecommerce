...
namespace Ecommerce.Location.Infrastructure.Migrations
{
    ...
    public partial class Initiallizedatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    first_code = table.Column<string>(
                        type: "character varying(5)",
                        maxLength: 5,
                        nullable: false
                    ),
                    second_code = table.Column<string>(
                        type: "character varying(5)",
                        maxLength: 5,
                        nullable: true
                    ),
                    third_code = table.Column<string>(
                        type: "character varying(5)",
                        maxLength: 5,
                        nullable: true
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ward_or_communes");

            migrationBuilder.DropTable(name: "districts");

            migrationBuilder.DropTable(name: "state_or_provinces");
