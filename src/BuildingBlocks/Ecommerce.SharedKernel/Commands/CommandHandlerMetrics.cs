using Ecommerce.SharedKernel.ActivityScope;
using Ecommerce.SharedKernel.OpenTelemetry;

namespace Ecommerce.SharedKernel.Commands;

/// <summary>
///     ref: https://github.com/oskardudycz/EventSourcing.NetCore/blob/main/Core/Commands/CommandHandlerMetrics.cs
/// </summary>
